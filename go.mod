...
require (
	...
	k8s.io/kubelet v0.0.0-20240306175034-1196e07a3e8d
...
replace (
	...
	k8s.io/cri-api => k8s.io/cri-api v0.0.0-20240306174858-30022f215cd7
	k8s.io/kubelet => k8s.io/kubelet v0.0.0-20240306175034-1196e07a3e8d
)
