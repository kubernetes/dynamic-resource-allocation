...
require (
	...
	k8s.io/kubelet v0.0.0-20231101144445-b16ea217865f
)
...
replace (
	...
	k8s.io/cri-api => k8s.io/cri-api v0.0.0-20231101144152-c783d8c092eb
	k8s.io/kubelet => k8s.io/kubelet v0.0.0-20231101144445-b16ea217865f
)
