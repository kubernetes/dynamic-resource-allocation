...
require (
	...
	k8s.io/kubelet v0.0.0-20230807222541-cad308c91a9f
)
...
replace (
	...
	k8s.io/cri-api => k8s.io/cri-api v0.0.0-20230807222306-883e293a852e
	k8s.io/kubelet => k8s.io/kubelet v0.0.0-20230807222541-cad308c91a9f
)
