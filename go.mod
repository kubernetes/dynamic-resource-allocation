...
require (
	...
	k8s.io/kubelet v0.0.0-20230606224224-5c87f3a35098
)
...
replace (
	...
	k8s.io/cri-api => k8s.io/cri-api v0.0.0-20230606224110-3af9919ef966
	k8s.io/kubelet => k8s.io/kubelet v0.0.0-20230606224224-5c87f3a35098
)
