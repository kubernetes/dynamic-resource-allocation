...
require (
	...
	k8s.io/kubelet v0.0.0-20231101174832-d6a3849db832
...
replace (
	...
	k8s.io/cri-api => k8s.io/cri-api v0.0.0-20231101174708-faf8b653b637
	k8s.io/kubelet => k8s.io/kubelet v0.0.0-20231101174832-d6a3849db832
)
