...
require (
	...
	k8s.io/kubelet v0.0.0-20231010154640-eebe25031351
...
replace (
	...
	k8s.io/cri-api => k8s.io/cri-api v0.0.0-20231010154517-2ad0fa5331c9
	k8s.io/kubelet => k8s.io/kubelet v0.0.0-20231010154640-eebe25031351
)
