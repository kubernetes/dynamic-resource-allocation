...
require (
	...
	k8s.io/kubelet v0.0.0-20240110193726-eece181a3ec4
...
replace (
	...
	k8s.io/cri-api => k8s.io/cri-api v0.0.0-20240110193258-6fa3891373fb
	k8s.io/kubelet => k8s.io/kubelet v0.0.0-20240110193726-eece181a3ec4
)
