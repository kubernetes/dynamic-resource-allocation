...
require (
	...
	k8s.io/kubelet v0.0.0-20230904124618-65cf3e334292
)
...
replace (
	...
	k8s.io/cri-api => k8s.io/cri-api v0.0.0-20230830142048-885a47cd1218
	k8s.io/kubelet => k8s.io/kubelet v0.0.0-20230904124618-65cf3e334292
)
