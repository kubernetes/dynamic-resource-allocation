...
require (
	...
	k8s.io/kubelet v0.0.0-20230619013929-97924579d961
)
...
replace (
	...
	k8s.io/cri-api => k8s.io/cri-api v0.0.0-20230619013809-bc387628fcdd
	k8s.io/kubelet => k8s.io/kubelet v0.0.0-20230619013929-97924579d961
)
