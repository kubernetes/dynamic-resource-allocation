...
require (
	...
	k8s.io/kubelet v0.0.0-20231016234510-32bad8037ff5
...
replace (
	...
	k8s.io/cri-api => k8s.io/cri-api v0.0.0-20231016195924-238702a99bb4
	k8s.io/kubelet => k8s.io/kubelet v0.0.0-20231016234510-32bad8037ff5
)
