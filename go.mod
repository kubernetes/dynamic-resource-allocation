...
require (
	...
	k8s.io/api v0.0.0-20260126215353-6fa173140947
	...
	k8s.io/kubelet v0.0.0-20260122222307-ce0febd5f9e2
...
require (
	...
	k8s.io/component-base v0.0.0-20260124054925-caa0d30d0512 // indirect
