...
require (
	...
	k8s.io/kubelet v0.0.0-20240110193632-d1ea87a8d27c
)
...
replace (
	...
	k8s.io/cri-api => k8s.io/cri-api v0.0.0-20240110193211-fa932ec89296
	k8s.io/kubelet => k8s.io/kubelet v0.0.0-20240110193632-d1ea87a8d27c
)
