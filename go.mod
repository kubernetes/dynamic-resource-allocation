...
require (
	...
	k8s.io/kubelet v0.0.0-20240307214313-eac40c789a06
)
...
replace (
	...
	k8s.io/cri-api => k8s.io/cri-api v0.0.0-20240307213042-e06bbfce09e7
	k8s.io/kubelet => k8s.io/kubelet v0.0.0-20240307214313-eac40c789a06
)
