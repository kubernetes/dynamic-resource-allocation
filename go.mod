...
require (
	...
	k8s.io/kubelet v0.0.0-20230718063615-6f5021b1251c
)
...
replace (
	...
	k8s.io/cri-api => k8s.io/cri-api v0.0.0-20230718024918-665004204078
	k8s.io/kubelet => k8s.io/kubelet v0.0.0-20230718063615-6f5021b1251c
)
