...
require (
	...
	k8s.io/kubelet v0.0.0-20230628225521-33e77d360dbd
)
...
replace (
	...
	k8s.io/apiserver => k8s.io/apiserver v0.0.0-20230706112519-24d5ac4b9868
	...
	k8s.io/kubelet => k8s.io/kubelet v0.0.0-20230628225521-33e77d360dbd
)
