...
require (
	...
	k8s.io/kubelet v0.0.0-20231010194629-2d73d8ae425a
...
replace (
	...
	k8s.io/cri-api => k8s.io/cri-api v0.0.0-20231010194502-3c717ca8994a
	k8s.io/kubelet => k8s.io/kubelet v0.0.0-20231010194629-2d73d8ae425a
)
